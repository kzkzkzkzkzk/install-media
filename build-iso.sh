...
ADDITIONAL_PACKAGES="\
    https://github.com/ChimeraOS/linux-chimeraos/releases/download/v6.5.1-chos3-1/linux-chimeraos-6.5.1.chos3-1-x86_64.pkg.tar.zst \
    https://github.com/ChimeraOS/linux-chimeraos/releases/download/v6.5.1-chos3-1/linux-chimeraos-headers-6.5.1.chos3-1-x86_64.pkg.tar.zst \
"
